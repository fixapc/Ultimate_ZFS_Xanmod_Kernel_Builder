...
complete -c delgroup -l conf -s c -d 'Use file instead of the default files /etc/deluser. conf and /etc/adduser'
complete -c delgroup -l group -d 'Remove a group'
complete -c delgroup -l help -s h -d 'Display brief instructions'
complete -c delgroup -l quiet -s q -d 'Suppress progress messages'
complete -c delgroup -l debug -d 'Be verbose, most useful if you want to nail down a problem'
...
complete -c delgroup -l no-preserve-root -d 'user by accident'
