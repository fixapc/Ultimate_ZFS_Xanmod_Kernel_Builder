...
complete -c llvm-cov -l help -d 'Display available options (âhelp-hidden for more)'
...
complete -c llvm-cov -s o -l object-directory -l object-file -d 'Find objects in DIR or based on FILEâs path'
...
complete -c llvm-cov -s u -l unconditional-branches -d 'Include unconditional branches in the output for the âbranch-probabilities …'
...
complete -c llvm-cov -o format -d 'Use the specified output format'
