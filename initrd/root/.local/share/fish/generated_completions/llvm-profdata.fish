...
complete -c llvm-profdata -l gcc -d 'Emit the profile using GCCâs gcov format (Not yet supported)'
...
complete -c llvm-profdata -l function -d 'Print details for a function if the functionâs name contains the given stri…'
