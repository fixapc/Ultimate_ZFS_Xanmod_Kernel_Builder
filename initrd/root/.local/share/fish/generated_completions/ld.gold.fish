...
complete -c 'ld.gold' -l keep-files-mapped -d 'Keep files mapped across passes (default)'
complete -c 'ld.gold' -l no-keep-files-mapped -d 'Release mapped files after each pass'
...
complete -c 'ld.gold' -l map-whole-files -d 'Map whole files to memory (default)'
complete -c 'ld.gold' -l no-map-whole-files -d 'Map relevant file parts to memory'
